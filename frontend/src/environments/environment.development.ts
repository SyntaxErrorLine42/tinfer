// These API keys are meant to be used publicly, so putting them in the client env is safe (can also be pushed to github)
export const environment = {
  production: false,
  apiUrl: 'http://localhost:8080', // Backend API URL (proxied during development)
